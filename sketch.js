...
function setup() {
  ...
  plr = createSprite(350,height-150);
  plr.addAnimation( "running",idle_img);
  plr.scale = 2;

  land10 = createSprite(1700,height-40);
  ...
  land0 = createSprite(1570,height-40);
  ...
  land9 = createSprite(1440,height-40);
  ...
  land8 = createSprite(1310,height-40);
  ...
  land7 = createSprite(1180,height-40);
  ...
  land6 = createSprite(1050,height-40);
  ...
  land5 = createSprite(790+130,height-40);
  ...
  land4 = createSprite(790,height-40);
  ...
  land3 = createSprite(660,height-40);
  ...
  land2 = createSprite(530,height-40);
  ...
  land1 = createSprite(400,height-40);
...
function spawntiles() {
  ...
  if (frameCount% 79 === 0 ) {
    ...
    var tiles1 =  createSprite(width+150,tiles.y,40,10);
    tiles1.addImage("tile",tile);
    tiles1.scale = 2.5;
    tiles1.setCollider("rectangle",0,0,60,37,0);
  tiles1.velocityX = -7;

    var tiles2 =  createSprite(width+250,tiles.y,40,10);
    tiles2.addImage("tile",tile);
    tiles2.scale = 2.5;
    tiles2.setCollider("rectangle",0,0,60,37,0);
   tiles2.velocityX = -7;

   var tiles3 =  createSprite(width+350,tiles.y,40,10);
  ...
  if(frameCount% 316=== 0 && score>400){
    var spike = createSprite(width+150,tiles.y-30,20,20);
